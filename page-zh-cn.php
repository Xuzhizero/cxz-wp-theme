          ...
          <div class="row" style="display: flex; flex-wrap: wrap; justify-content: center;">
            <div class="article col col-4 col-d-6 col-t-12 custom-tall-card">
              ...
              <div class="article__inner">
                <div class="article__content">
                  ...
                  <h2 class="article__title">
                    <a href="https://blog.csdn.net/a2213086589?type=blog">查看我的 CSDN 技术博客</a>
                  </h2>
            ...
            <div class="article col col-4 col-d-6 col-t-12 custom-tall-card">
              <a href="https://www.linkedin.com/feed/" class="article__image">
                <img src="<?php echo esc_url( get_stylesheet_directory_uri() . '/assets/img/link-linkedin-photo.png' ); ?>" alt="LinkedIn" loading="lazy">
              </a>
              <div class="article__inner">
                <div class="article__content">
                  <div class="article__meta">
                  ...
                  <h2 class="article__title">
                    <a href="https://www.linkedin.com/feed/">查看我的 LinkedIn 主页</a>
                  </h2>
           ...
           <div style="text-align: left;">
              ...
              <ul style="list-style: none; padding: 0; margin: 0; display: flex; flex-direction: column; gap: 15px;">
                 ...
                 <li style="display: flex; align-items: center;">
                    ...
                    <a href="https://www.linkedin.com/feed/" style="font-size: 18px; color: var(--text-color); text-decoration: none;">我的 LinkedIn</a>
                 </li>
                 ...
                 <li style="display: flex; align-items: center;">
                    ...
                    <a href="https://space.bilibili.com/1080349852?spm_id_from=333.788.0.0" style="font-size: 18px; color: var(--text-color); text-decoration: none;">在 YouTube 关注我</a>
                 </li>
                 ...
                 <li style="display: flex; align-items: center;">
                    ...
                    <a href="https://blog.csdn.net/a2213086589?type=blog" style="font-size: 18px; color: var(--text-color); text-decoration: none;">CSDN 技术博客</a>
                 </li>
                 ...
                 <li style="display: flex; align-items: center;">
                    ...
                    <a href="https://www.yuque.com/caogongzi" style="font-size: 18px; color: var(--text-color); text-decoration: none;">语雀文档</a>
                 </li>
